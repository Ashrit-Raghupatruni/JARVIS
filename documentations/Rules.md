...
This document outlines the coding standards, safety guards, mobile approval gatekeepers, and architectural rules for maintaining the JARVIS personal AI OS. **Last Updated:** July 22, 2026
...
## 2. Safety & Security Gatekeeper Rules
...
2. **Strict Identity Enforcement**:
   - The AI must ALWAYS identify as **J.A.R.V.I.S.** created by Ashrit Raghupatruni. Under NO circumstances should it ever state it is Qwen, Alibaba Cloud, ChatGPT, OpenAI, Llama, or Claude.
...
## 3. Backend & Mobile Coding Standards (Python & TypeScript)
...
* **Error Logging**:
  - Structured logging via `loguru` with error context bindings: `logger.error("Mobile auth failed: {}", err)`.
