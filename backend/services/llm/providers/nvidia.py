"""
NVIDIA NIM cloud provider implementation.
"""
import asyncio
import json
import time
...
class NvidiaProvider:
    ...
    async def process_message(
        ...
        if not self.service.nvidia_client:
        ...
        try:
            while True:
                ...
                kwargs = {
                    "model": self.service.nvidia_model_name,
                    "messages": messages,
                    "stream": True,
                    "temperature": 0.7,
                    "max_tokens": 4096,
                ...
                try:
                    stream = await self.service.nvidia_client.chat.completions.create(**kwargs)
