...
class OpenRouterProvider:
    ...
    async def process_message(
        ...
        if not self.service.openrouter_client:
        ...
        try:
            while True:
                ...
                kwargs = {
                    "model": self.service.openrouter_model_name,
                    "messages": messages,
                    "stream": True,
                    "temperature": 0.7,
                    "max_tokens": 4096,
                ...
                try:
                    stream = await self.service.openrouter_client.chat.completions.create(**kwargs)
