...
const styles = StyleSheet.create({
  ...
  title: { color: '#00e5ff', fontSize: 18, fontWeight: 'bold', fontFamily: 'monospace', letterSpacing: 2 },
  badge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12 },
  online: { backgroundColor: 'rgba(0, 229, 255, 0.2)', borderWidth: 1, borderColor: '#00e5ff' },
  offline: { backgroundColor: 'rgba(255, 0, 85, 0.2)', borderWidth: 1, borderColor: '#ff0055' },
  badgeText: { color: '#ffffff', fontSize: 10, fontWeight: 'bold' },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  card: { width: '48%', backgroundColor: '#0e1726', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(0, 229, 255, 0.2)' },
  cardFull: { width: '100%', backgroundColor: '#0e1726', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(0, 229, 255, 0.2)', marginTop: 8 },
  cardLabel: { color: '#88a0c0', fontSize: 11, fontWeight: 'bold', fontFamily: 'monospace' },
  cardValue: { color: '#00e5ff', fontSize: 24, fontWeight: 'black', marginVertical: 4 },
  cardTask: { color: '#ffffff', fontSize: 15, fontWeight: 'bold', marginVertical: 4 },
  cardSub: { color: '#557090', fontSize: 11 }
});
